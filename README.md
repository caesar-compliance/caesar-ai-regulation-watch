...
**Status:** v0.5.1 — global coverage map, human review queue, timelines, CI validate/build, search, and JSON/RSS exports (no watchers, APIs, database, auth, or runtime remote fetch)
