...
**Current live release:** v1.0.5 (T048 automation-first tracker skeleton) at [regulation-watch.caesar.no](https://regulation-watch.caesar.no/) — `DEPLOY-20260520-023`, tag `regulation-watch-v1.0.5`. Previous live base: v1.0.4.
