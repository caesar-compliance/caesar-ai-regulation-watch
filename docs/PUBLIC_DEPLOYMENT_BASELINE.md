...
**Phase:** v1.0.7 live — choropleth map + jurisdiction comparison (T050). **v1.0.8 (T051–T055)** — T051–T054 on main; T055 adds one-off network dry-run execution (local `generated/` only, not deployed). Tag `regulation-watch-v1.0.8` and deploy pending future Control Tower approval.
