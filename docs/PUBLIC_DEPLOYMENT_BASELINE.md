...
**Phase:** v1.0.8 live; v1.0.9 (T061 merged `71bd4ef`) deploy pending. T061 item-level manual results at `/source-verification/`; `verified_on_source` false; internal drafts excluded from public exports.
