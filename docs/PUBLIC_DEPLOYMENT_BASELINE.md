...
**Phase:** v1.0.7 live — choropleth map + jurisdiction comparison (T050). **v1.0.8 (T051–T058)** — T051–T057 on main; T058 draft revision on branch; T056 draft/T057 decision/T058 revision excluded from public exports. Tag `regulation-watch-v1.0.8` and deploy pending future Control Tower approval.
