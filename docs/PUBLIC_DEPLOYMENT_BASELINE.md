...
**Phase:** v1.0.7 live — choropleth map + jurisdiction comparison (T050). **v1.0.8 (T051–T059)** — T051–T058 on main; T059 readiness gate in progress; T056 draft/T057 decision/T058 revision/T059 readiness excluded from public exports. Tag `regulation-watch-v1.0.8` and deploy pending future Control Tower approval.
