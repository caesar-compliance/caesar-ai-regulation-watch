...
const publicExportApprovalDecisionCheck = spawnSync(
  process.execPath,
  [path.join(ROOT, "scripts/validate-public-export-approval-decisions.mjs")],
  { cwd: ROOT, stdio: "inherit" },
);
if (publicExportApprovalDecisionCheck.status !== 0) {
