...
**Phase:** v1.0.7 live — choropleth map + jurisdiction comparison (T050). **v1.0.8 (T051 + T052 + T053 + T054)** on main (T051 PR #11; T052 PR #12; T053 PR #13 squash `0469a9e`; T054 PR #14 squash `78a00be`). T054 network dry-run approval (planning-only) — no live collection. Tag `regulation-watch-v1.0.8` and deploy pending future Control Tower approval.
