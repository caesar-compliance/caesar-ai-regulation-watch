...
**Codebase:** v1.0.27 (T076A services onboarding). **Live:** v1.0.26 at [regulation-watch.caesar.no](https://regulation-watch.caesar.no/) until v1.0.27 deploy. **Next:** Artem fills Account A local env → T075B Supabase pilot DB → T076 network check after approval.
