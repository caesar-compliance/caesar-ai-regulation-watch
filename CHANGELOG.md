...
- **System Specifications:** Created [SPEC.md](SPEC.md) detailing inputs, outputs, non-goals, and crawler boundaries.
- **Architectural Scaffolding:** Added [ARCHITECTURE.md](ARCHITECTURE.md) outlining mapping structures and database boundaries.
