...
**Phase:** v1.0.7 live — choropleth map + jurisdiction comparison (T050). **v1.0.8 (T051 + T052 + T053)** implemented on main (T051 PR #11; T052 PR #12). T053 manual source intake runner (fixture-first) — no live collection. Tag `regulation-watch-v1.0.8` and deploy pending future Control Tower approval.
