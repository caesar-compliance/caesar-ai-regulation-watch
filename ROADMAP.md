...
**Codebase:** v1.0.8 (T051–T056; T051–T055 on main) — tag/deploy pending. **Live:** v1.0.7 at [regulation-watch.caesar.no](https://regulation-watch.caesar.no/) — `DEPLOY-20260520-025`, tag `regulation-watch-v1.0.7`. **Next:** T057 manual reviewer decision workflow for T056 draft (still no publication).
