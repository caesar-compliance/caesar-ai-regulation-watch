...
**Codebase:** v1.0.22 (T074 runtime bootstrap). **Live:** v1.0.21 at [regulation-watch.caesar.no](https://regulation-watch.caesar.no/) until T074 deploy. **Next:** T075 controlled runtime pilot after Supabase credentials; live monitoring architecture before SaaS dashboard.
