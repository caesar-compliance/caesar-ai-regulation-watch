...
**Current release:** v1.0.6 (T049 offline metadata adapter) at [regulation-watch.caesar.no](https://regulation-watch.caesar.no/) — `DEPLOY-20260520-024` (deploy in progress). **Next:** T050 choropleth map + compare jurisdictions.
