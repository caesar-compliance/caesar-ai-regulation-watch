...
**Phase:** v1.0.7 live — choropleth map + jurisdiction comparison (T050). **v1.0.8 (T051)** release candidate on branch `task/T051-rich-country-profiles-drilldowns` — deploy pending Control Tower.
