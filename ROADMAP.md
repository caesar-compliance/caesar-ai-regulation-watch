...
**Codebase:** v1.0.25 (T075D decision packets). **Live:** v1.0.25 at [regulation-watch.caesar.no](https://regulation-watch.caesar.no/). **Next:** T075E export polish or T075B when Supabase configured → T076 explicit network check after approval.
