...
**Codebase:** v1.0.26 (T075E operator handoff). **Live:** v1.0.25 at [regulation-watch.caesar.no](https://regulation-watch.caesar.no/) until deploy. **Next:** T075B when Supabase configured → T076 explicit network check after approval.
