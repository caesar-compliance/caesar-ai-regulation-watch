...
**Codebase:** v1.0.22 (T074 live; T075A source pilot framework on branch). **Live:** v1.0.22 at [regulation-watch.caesar.no](https://regulation-watch.caesar.no/). **Next:** T075A merge → T075B runtime DB connection when Supabase configured → T076 explicit network check after approval.
