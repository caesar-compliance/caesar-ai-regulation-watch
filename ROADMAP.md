...
**Codebase:** v1.0.8 (T051–T057 on main; T058 on branch) — tag/deploy pending. **Live:** v1.0.7 at [regulation-watch.caesar.no](https://regulation-watch.caesar.no/) — `DEPLOY-20260520-025`, tag `regulation-watch-v1.0.7`. **Next:** T059 internal draft promotion readiness gate (still no publication).
