...
| Field | Value |
|---|---|
| **Current version** | `v1.0.12` (T064 — legal review revision response UI) |
| **Live version** | `v1.0.12` — tag `regulation-watch-v1.0.12` |
| **Status** | T064 merged and deployed; live site v1.0.12 |
