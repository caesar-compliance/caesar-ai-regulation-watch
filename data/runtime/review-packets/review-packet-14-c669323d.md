# Review packet 14: Report on the use of SPE external experts in 2025

> **Not legal advice.** Metadata-only monitoring signal. Human review required before any legal or client use.

## Review required

- **Candidate ID:** `c669323d-14d9-452f-816e-cedf6799fece`
- **Priority:** high
- **Review status:** review_required
- **Jurisdiction:** eu
- **Source:** European Data Protection Board (EDPB) — publications RSS (`edpb-publications-rss`)
- **Change type:** added
- **Detected at:** 2026-05-22T14:22:49.339Z

## Source

- Official URL: https://www.edpb.europa.eu/our-work-tools/our-documents/support-pool-experts-projects/report-use-spe-external-experts-2025_en

## Metadata summary

New metadata item detected: Report on the use of SPE external experts in 2025
