...
**Phase:** v1.0.20 live — T072 deployed 21 May 2026 (`DEPLOY-20260521-038`, commit `bbfefcc`, tag `regulation-watch-v1.0.20`). T072 `T072-001` explicit approval packet on `/publication-release/`; awaiting Control Tower authorization; publication not authorized; gates closed.
