# Review packet 8: New episode of the Newsletter Digest is out

> **Not legal advice.** Metadata-only monitoring signal. Human review required before any legal or client use.

## Review required

- **Candidate ID:** `344ad1e5-70bd-48a8-8ad1-242e9a383873`
- **Priority:** high
- **Review status:** review_required
- **Jurisdiction:** eu
- **Source:** European Data Protection Supervisor (EDPS) — news RSS (`edps-news-rss`)
- **Change type:** added
- **Detected at:** 2026-05-22T14:22:51.082Z

## Source

- Official URL: https://www.edps.europa.eu/press-publications/press-news/news/2026/new-episode-newsletter-digest-out

## Metadata summary

New metadata item detected: New episode of the Newsletter Digest is out
