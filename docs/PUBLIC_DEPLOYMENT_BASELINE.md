...
**Phase:** v1.0.22 live — T074 deployed 21 May 2026 (`DEPLOY-20260521-040`, commit `2b7bdd4`, tag `regulation-watch-v1.0.22`). `/automation/`, `/runtime-health/`, runtime DB health JSON; Supabase `not_configured`; live ingestion disabled; no Worker deployed; no Supabase migration applied. Publication still not authorized; gates closed.
