...
**Phase:** v1.0.12 live — T064 deployed 21 May 2026 (`DEPLOY-20260521-030`, commit `38af753`, tag `regulation-watch-v1.0.12`). `/legal-review/` `T064-001` ready for reviewer re-check; not approved; gates closed.
