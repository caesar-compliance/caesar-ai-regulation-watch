...
**Codebase:** v1.0.25 + T075E operator handoff (branch). **Live:** v1.0.25 at [regulation-watch.caesar.no](https://regulation-watch.caesar.no/). **Next:** T075E merge/deploy or T075B when Supabase configured → T076 explicit network check after approval.
