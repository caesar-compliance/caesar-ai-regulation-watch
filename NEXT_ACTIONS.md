...
**Current codebase:** v1.0.8 (T051–T060) — live `DEPLOY-20260521-026`, commit `299464a`, tag `regulation-watch-v1.0.8`
**Live release:** v1.0.8 — deployed 21 May 2026
...
16. **T061 — Manual source URL verification result capture** *(next)*
