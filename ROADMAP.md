...
**Current live release:** v1.0.5 (T048 tracker skeleton) at [regulation-watch.caesar.no](https://regulation-watch.caesar.no/) — `DEPLOY-20260520-023`. **In development:** T049 offline metadata adapter for updates feed (not yet deployed).
