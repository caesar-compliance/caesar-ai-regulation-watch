...
| **Deployed commit** | `57acfcf` (`merge: v0.8.4 static deployment readiness`) |
...
| **Workflow run ID** | [26130431228](https://github.com/caesar-compliance/caesar-ai-regulation-watch/actions/runs/26130431228) |
