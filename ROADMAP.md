...
**Codebase:** v1.0.24 (T075C live). **Live:** v1.0.24 at [regulation-watch.caesar.no](https://regulation-watch.caesar.no/). **Next:** T075D offline review decision packet (no Supabase) or T075B when Supabase configured → T076 explicit network check after approval.
