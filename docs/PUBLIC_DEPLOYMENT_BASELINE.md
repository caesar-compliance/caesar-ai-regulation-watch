...
**Phase:** v1.0.17 codebase — T069 `/public-export-gate/` gate `T069-001` internal only; live v1.0.16 until deploy. Next step `public_export_approval_decision`; gates closed.
