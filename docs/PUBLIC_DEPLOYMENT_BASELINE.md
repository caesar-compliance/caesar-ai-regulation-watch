...
**Phase:** v1.0.18 live — T070 deployed 21 May 2026 (`DEPLOY-20260521-036`, commit `d3a0653`, tag `regulation-watch-v1.0.18`). T071 `T071-001` publication held; next `explicit_publication_release_approval`; v1.0.19 deploy pending; gates closed.
